...
canPressAgain = true;
gameOK = true;
setInterval(gametic, speed - 100*lvl );
...
function keyDownHandler(e) {
    if (canPressAgain){
        if(e.key == "w" || e.key == "W" && downPressed == false) {
            upPressed = true;
            downPressed = false;
            leftPressed = false;
            rightPressed = false;
        }
        else if(e.key == "S" || e.key == "s" && upPressed == false) {
            downPressed = true;
            upPressed = false;
            leftPressed = false;
            rightPressed = false;
        }
        else if(e.key == "a" || e.key == "A" && rightPressed == false){
            leftPressed = true;
            upPressed = false;
            downPressed = false;
            rightPressed = false;
        }
        else if(e.key == "d" || e.key == "D" && leftPressed == false){
            rightPressed = true;
            upPressed = false;
            downPressed = false;
            leftPressed = false;
